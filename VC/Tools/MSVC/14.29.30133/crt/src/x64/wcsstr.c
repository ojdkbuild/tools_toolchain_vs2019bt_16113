...
/***
*wchar_t *wcsstr(characters1, characters2) - search for characters2 in characters1
*       (wide strings)
*
*Purpose:
*       finds the first occurrence of characters2 in characters1 (wide strings)
*
*Entry:
*       wchar_t *characters1 - string to search in
*       wchar_t *characters2 - string to search for
*
*Exit:
*       returns a pointer to the first occurrence of characters2 in
*       characters1, or NULL if characters2 does not occur in characters1
*
*Uses:
*
*Exceptions:
        ...
        )
{
    ...
    if (__isa_available < __ISA_AVAILABLE_SSE42)
    {
        ...
        if (0 == wcs2[0]) return (wchar_t *)wcs1;
